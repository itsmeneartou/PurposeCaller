...
public class YouTubePlayerView extends FrameLayout implements NetworkReceiver.NetworkListener, LifecycleObserver {
    ...
    public void addinteractionView(View v){
        Log.e("beforeChildCount","childCount:"+this.getChildCount());
        addView(v,1,new LayoutParams((int)convertDpToPixel(160),(int)convertDpToPixel(90), Gravity.TOP|Gravity.RIGHT));
        Log.e("beforeChildCount","childCount:"+this.getChildCount());
    }
